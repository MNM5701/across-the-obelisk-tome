let allCards = []; 
        ...
        function renderTraitsUI() {
            ...
            let imageName = currentHero.name;
            if (imageName === "Evelyn") imageName = "Evenlyn"; // Handle typo in uploaded files
            ...
            let finalHtml = `
                <div style="display: flex; gap: 20px; align-items: stretch; width: 100%;">
                    <div style="flex: 0 0 180px; display: flex; align-items: center; justify-content: center; background: rgba(0,0,0,0.2); border-radius: var(--border-radius-md); border: 1px solid var(--border-light);">
                        <img src="./Hero%20Images/${imageName}.png" alt="${currentHero.name}" style="max-width: 100%; max-height: 250px; object-fit: contain; filter: drop-shadow(0 4px 10px rgba(0,0,0,0.5));" onerror="this.parentElement.style.display='none'">
                    </div>
